document.addEventListener('DOMContentLoaded', function() {
    ...
    let imagenes = [
                 {img: './imgs/galeria/1.jpg'},
                 {img: './imgs/galeria/2.jpg'},
                 {img: './imgs/galeria/3.jpg'},
                 {img: './imgs/galeria/4.jpg'},
                 {img: './imgs/galeria/5.jpg'},
                 {img: './imgs/galeria/6.jpg'},
                 {img: './imgs/galeria/7.jpg'},
                 {img: './imgs/galeria/8.jpg'},
                 {img: './imgs/galeria/9.jpg'},
                 {img: './imgs/galeria/10.jpg'},
